...
const MarkAttendance = () => {
  ...
  const fetchTodayAttendance = async () => {
    try {
      ...
      const response = await axios.get(`https://new-backend-3-yxpd.onrender.com/api/attendance?date=${today}`);
  ...
  const handleMarkAttendance = async (customer) => {
    ...
    try {
      const response = await axios.post('https://new-backend-3-yxpd.onrender.com/api/attendance', {
  ...
  const handleRenewalSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://new-backend-3-yxpd.onrender.com/api/customers/${selectedCustomer._id}/renew`, renewalPayload);
