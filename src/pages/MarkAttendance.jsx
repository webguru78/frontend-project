...
const MarkAttendance = () => {
  ...
  const fetchTodayAttendance = async () => {
    try {
      ...
      const response = await axios.get(`https://amfitness.fun/api/attendance?date=${today}`);
  ...
  const handleMarkAttendance = async (customer) => {
    ...
    try {
      const response = await axios.post('https://amfitness.fun/api/attendance', {
  ...
  const handleRenewalSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://amfitness.fun/api/customers/${selectedCustomer._id}/renew`, renewalPayload);
