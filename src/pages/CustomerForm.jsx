...
const CustomerForm = () => {
  ...
  const checkRollNumberExists = async (rollNum) => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/customers/check-roll/${rollNum}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/customers`, submitData, {
