...
const WhatsAppManager = () => {
  ...
  const fetchWhatsAppStatus = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/whatsapp/status`);
  ...
  const initializeWhatsAppWeb = async () => {
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/init-whatsapp-web`);
  ...
  const requestWhatsAppVerification = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/request-whatsapp-verification`, {
  ...
  const verifyWhatsAppCode = async () => {
    ...
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/verify-whatsapp-code`, {
        phoneNumber: phoneNumber,
  ...
  const sendCustomMessage = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/send-message`, {
  ...
  const sendWelcomeMessage = async (customerId) => {
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/send-welcome`, {
        customerId
      });
  ...
  const sendFeeReminder = async (customerId) => {
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/send-fee-reminder`, {
        customerId
      });
  ...
  const triggerAllFeeReminders = async () => {
    setLoading(true);
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/trigger-fee-reminders`);
  ...
  const disconnectWhatsApp = async () => {
    setLoading(true);
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/whatsapp/disconnect`);
