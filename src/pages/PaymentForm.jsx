...
const PaymentForm = () => {
  ...
  const fetchRecentPayments = async () => {
    try {
      const response = await axios.get(`https://backend-deploy-ten-pi.vercel.app/api/payments/recent`);
  ...
  const confirmPayment = async () => {
    ...
    try {
      await axios.put(`https://backend-deploy-ten-pi.vercel.app/api/customers/${selectedCustomer}/payment`, {
